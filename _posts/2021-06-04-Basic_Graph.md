...
![](https://i.imgur.com/aU9nxfP.png =500x)
- degree centrality : degree 除以 network中的node數-1 (D/(N-1))
![](https://i.imgur.com/V9QW61P.png =500x)
...
- clustering coefficient (集聚係數) : 以C(i)表示node i的任兩個朋友也是朋友的機率
    - 3/C5取2 = 3/10 = 0.
![](https://i.imgur.com/PLhb2h7.png =350x)
...
![](https://i.imgur.com/b51BtbS.png =350x)
...
![](https://i.imgur.com/YQHSRz5.png =500x)
一些比較特別的例子
![](https://i.imgur.com/S2bvHXx.png =500x)
實際上資料匯存成的樣子是下面這種**list of edges**
![](https://i.imgur.com/34MjBna.png =500x)
